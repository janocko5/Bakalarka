...
fwrite($dockerfile, "FROM openjdk \n");
//fwrite($dockerfile, "COPY test.java / \n");
fwrite($dockerfile, "COPY mycode.java / \n");
fwrite($dockerfile, "CMD [\"java\", \"./mycode.java\"]");
$kod1 = implode(" ",$listz[0]);

$myfile = fopen("mycode.java", "w") or die("Unable to open file!");
