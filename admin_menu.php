...
<div class="filter-buttons">
    ...
    <a href="create.php">
        <div class="list-view-button"><i class="fa fa-code" aria-hidden="true"></i> Add</div>
    </a>
</div>
    ...
    for ($x = 0; $x < $count; $x++) {
        ...
        <li><?php echo $zad ?>
            ...
            <form action="#" method="post">
                ...
                <button class="btn btn-success" name="desc" value=  <?php $_SESSION['x'] = $x; ?>> Pridaj testy k zadaniu </button>
            </form>
            <form action="#" method="post">
                <input style="display: none" type="text" name="subject2" id="subject" value= <?php custom_echo(implode(" ", [$x]), 200); ?>>
                <button class="btn btn-success" name="desc" value=  <?php custom_echo(implode(" ", [$x]), 200); ?>> Ohodnotit </button>
            </form>
            <form action="delete.php" method="post">
                <input style="display: none" type="text" name="subject1" id="subject" value= <?php $id ?>>
                <button class="btn btn-success" name="desc" value=  <?php $id ?>> <?php echo $id ?></button>
            </form>
        </li>
